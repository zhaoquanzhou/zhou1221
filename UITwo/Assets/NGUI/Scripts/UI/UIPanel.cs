...
public class UIPanel : UIRect
{
    ...
    [HideInInspector] [SerializeField] private Texture2D mClipTexture = null;

    // Panel's alpha (affects the alpha of all widgets)
    [HideInInspector] [SerializeField] private float mAlpha = 1f;

    // Clipping rectangle
    [HideInInspector] [SerializeField] private UIDrawCall.Clipping mClipping = UIDrawCall.Clipping.None;

    [HideInInspector] [SerializeField] private Vector4 mClipRange = new Vector4(0f, 0f, 300f, 200f);
    [HideInInspector] [SerializeField] private Vector2 mClipSoftness = new Vector2(4f, 4f);
    [HideInInspector] [SerializeField] private int mDepth = 0;
    [HideInInspector] [SerializeField] private int mSortingOrder = 0;
    ...
    [SerializeField] private Vector2 mClipOffset = Vector2.zero;
    ...
    private bool mUpdateScroll = false;
